...
API_KEY = "RGAPI-b093334f-c0ee-4bb8-a0db-4b9eedac3a40"
...
def main():
    name = "Irucin"
    server = "NA"
    summoner = Summoner(puuid="9ydrHSXJcdONbjsFEYZIRxZscA4aDXgc8j4UYhwVhnk-LQlI1aGQXXoNorr0CqQ04O1ckPu0KZ4Gpw", region=server)
